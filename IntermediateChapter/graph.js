  ...
  for (let i = 1; i <= numLines; i++) {
    ...
    d3.selectAll('#d3-viz6')
      ...
      .attr('cx', function () {
        ...
        // }
        // return x;
        let x = widthD3 / 3 + (Math.random() - 0.5) * 10;
        return x;
      })
      .attr('cy', yScalePlus(i * 10))
      .attr('r', 1.5);
    ...
    d3.selectAll('#d3-viz6')
      ...
      .attr('cx', function () {
        ...
        // }
        // return x;
        let x = 2 * widthD3 / 3 + (Math.random() - 0.5) * 10;
        return x;
      })
      .attr('cy', yScalePlus(i * 10))
      .attr('r', 1.5);
...
d3bands2AddElec = () => {
  ...
  svg.append('circle')
    ...
    .attr('cy', yScalePlus(Math.floor(Math.random() * numLines) * 10))
    .attr('r', 5)
    .attr('fill', colors.yellow);
}
...
d3bands2Transition = () => {
  ...
  d3.select('#d3-viz7')
    ...
    .append('circle')
    .attr('cx', widthD3 / 2 + (0.5 * Math.random()) * 200)
    .attr('cy', yScaleMinus(Math.floor(Math.random() * numLines) * -10))
    .attr('r', 5)
    .attr('fill', colors.yellow);
}
...
//   d3.selectAll('#d3-viz').append('g')
//     .call(yAxis)
//     .attr('transform', `translate(58,0)`)
//     .attr('class', 'axis');

//   d3.selectAll('#d3-viz').append("text")
//     .attr("transform", "rotate(-90)")
//     .attr("y", 30)
//     .attr("x", 0 - (heightD3 / 2))
//     .attr("dy", "1em")
