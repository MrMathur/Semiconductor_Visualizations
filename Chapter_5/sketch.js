...
function draw() {
  ...
  if (sceneCount == 0.5) {
    ...
    fill(255, 247, 174);
    text("Conductor", 2 * width / 5 - 2, height / 2 + 50);

    noStroke();
    rect(2 * width / 5 - 75, height / 2 - 100, 150, 50);
    rect(2 * width / 5 - 75, height / 2 - 60, 150, 50);
    fill(110, 207, 127);
    text("Semiconductor", 3 * width / 5, height / 2 + 50);

    noStroke();
    rect(3 * width / 5 - 75, height / 2 - 140, 150, 50);
    rect(3 * width / 5 - 75, height / 2 - 60, 150, 50);
    fill(110, 207, 127);

    fill(234, 159, 162);
    text("Insulator", 4 * width / 5, height / 2 + 50);

    noStroke();
    rect(4 * width / 5 - 75, height / 2 - 200, 150, 50);
    rect(4 * width / 5 - 75, height / 2 - 60, 150, 50);
    fill(110, 207, 127);

    textSize(16);

    fill(255, 247, 174);
    text("0 band gap", 2 * width / 5 - 2, height / 2 + 100);
    fill(110, 207, 127);
    text("Small band gap", 3 * width / 5, height / 2 + 100);
    fill(234, 159, 162);
    text("Large band gap", 4 * width / 5, height / 2 + 100);
